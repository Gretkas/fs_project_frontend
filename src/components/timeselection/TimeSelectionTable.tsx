  ...
  (props: IVisualTimeSelectionTable) => {
    const [reservationTable, setReservationTable] = useState(
      new TimeSelectionTable(
        props.reservedArray ? props.reservedArray : defaultReservationTable,
        handleOnClick
      )
    );
...
export interface IVisualTimeSelectionTable {
  reservedArray?: boolean[][];
  reservationTime: [number | undefined, number | undefined];
  setReservationTime: (selection:[number | undefined, number | undefined])=> void;
}
